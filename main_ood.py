...
def main():
    ...
    cache_dir = os.path.join('./caches', id_cfg['dataset'])
    os.makedirs(cache_dir, exist_ok=True)
    id_cfg['cache_dir'] = cache_dir
    ...
    id_dataset = build_dataset(id_cfg['dataset'], id_cfg['root_path'], id_cfg['shots'], id_cfg['data_section'])
    ...
    train_loader_F = build_data_loader(data_source=id_dataset.train_x, batch_size=256, tfm=train_tranform, is_train=True,
                                       shuffle=True)
    ...
    # ------------------------------------------ Tip-Adapter ------------------------------------------
    run_tip_adapter(id_cfg, cache_keys, cache_values, val_features, val_labels, test_features, test_labels, clip_weights)

    # ------------------------------------------ Tip-Adapter-F ------------------------------------------
    run_tip_adapter_F(id_cfg, cache_keys, cache_values, val_features, val_labels, test_features, test_labels, clip_weights,
                      clip_model, train_loader_F)
